...
public class GetListModelQuery : IRequest<GetListResponse<GetListModelListItemDto>>
{
    ...
    public class GetListModelQueryHander : IRequestHandler<GetListModelQuery, GetListResponse<GetListModelListItemDto>>
    {
        private readonly IModelRepository _modelRepository;
        private readonly IMapper _mapper;

        public GetListModelQueryHander(IModelRepository modelRepository, IMapper mapper)
        {
